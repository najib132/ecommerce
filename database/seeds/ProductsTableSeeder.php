    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'images' => '["products\/dummy\/desktop-2.jpg"]',
            ])->categories()->attach(2);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'images' => '["products\/dummy\/phone-2.jpg"]',
            ])->categories()->attach(3);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'images' => '["products\/dummy\/tablet-2.jpg"]',
            ])->categories()->attach(4);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'images' => '["products\/dummy\/tv-2.jpg"]',
            ])->categories()->attach(5);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'images' => '["products\/dummy\/camera-2.jpg"]',
            ])->categories()->attach(6);
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            Product::create([
                ...
                'images' => '["products\/dummy\/appliance-2.jpg"]',
            ])->categories()->attach(7);
        }
    }
}
