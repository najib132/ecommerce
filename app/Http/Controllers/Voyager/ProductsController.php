...
class ProductsController extends VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $requestNow          = $request;
        $requestNow['price'] = $request->price  * 100 ;

        $this->insertUpdateData($requestNow, $slug, $dataType->editRows, $data);
    ...
    public function store(Request $request)
    {
        ...
        $data = $this->insertUpdateData($requestNow, $slug, $dataType->addRows, new $dataType->model_name());
